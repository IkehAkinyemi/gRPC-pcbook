...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=ikehakinyemi.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x79, 0x65, 0x6d, 0x69, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x22, 0xb4, 0x01, 0x0a, 0x06,
	...
	0x75, 0x6e, 0x69, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x69, 0x6b, 0x65,
	...
	0x10, 0x06, 0x42, 0x05, 0x5a, 0x03, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: ikehakinyemi.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: ikehakinyemi.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: ikehakinyemi.pcbook.Memory.unit:type_name -> ikehakinyemi.pcbook.Memory.Unit
